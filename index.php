...
<head>
  ...
  <title>Купить Magic Look недорого. Цены, отзывы. Закажите Magic Look сейчас!</title>
  <link href="css/jquery.bxslider.css" rel="stylesheet">
  <link rel="icon" type="image/x-icon" href="img/favicon.ico">

  <link href="css/style.css" type="text/css" rel="stylesheet">
  <link href="css/res480.css" type="text/css" rel="stylesheet">
  <link href="css/res760.css" type="text/css" rel="stylesheet">
  <link href="css/resLarge.css" type="text/css" rel="stylesheet">
...
<body>
  ...
  <header>
    <div class="head_header">
      <div class="container">
        <img src="img/logo.png" alt="Magic Look" class="logo">
        <div class="center_head">
          <div class="center first">
            <img src="img/leaf.png" alt="">
            <p><b>100%</b> натуральный продукт</p>
          </div>
          <div class="center second">
            <img src="img/leader.png" alt="">
            <p><span>40260</span> человек довольны результатом</p>
          </div>
        </div>
        <div class="order_call"><a href="#feedback" class="scrolling">Отзывы клиентов</a></div>
      </div>
    </div>
    <div class="header_body">
      <div class="container">
        <h1>Magic Look — избавьтесь от темных кругов вокруг глаз за 2 недели</h1>
        <p class="header_body_subtitle">Растительная маска с пептидами шелка</p>
        <div class="col-4">
          <div class="just_14">
            <p class="title_ul_header">Всего за 14 дней!</p>
            <ul class="ul_header">
              <li>
                <p>Ваша кожа вокруг глаз вновь выглядит свежей и сияющей благодаря комплексному уходу</p>
              </li>
              <li class="yellow">
                <p>Растительные масла увлажняют и восстанавливают эластичность </p>
              </li>
              <li>
                <p>Пептиды шелка разглаживают морщинки и выравнивают тон</p>
              </li>
              <li class="yellow">
                <p>Экстракт конского каштана снимает отечность</p>
              </li>
            </ul>
            <p class="under_title_ul_header">Вы превосходно выглядите!</p>
          </div>
        </div>
        <!--
              -->
        <div class="col-4">
          <img src="img/sale.png" alt="" class="sale">
          <img src="img/prod.png" alt="" class="prod">
        </div>
        <!--
              -->
        <div class="col-4">
          <div class="col_form">
            <div class="form_header">
              <div class="head_form_header">
                <div class="price">
                  <div class="before">
                    <p class=" prev_price"><span class="x_price_previous line">13 900</span> <span class="x_currency previous"></span></p>
                  </div>
                  <div class="after">
                    <p class="price__after new">Новая цена</p>
                    <p class=" after_price"><span class="x_price_current">3 990</span> <span class="x_currency current"></span></p>
                  </div>
                </div>
                <div class="timer-wrap">
                  <p class="timer-title"><span>До конца акции осталось:</span></p>
                  <div class="under-timer">
                    <span class="under-timer-text--1">Часов</span>
                    <span class="under-timer-text--2">Минут</span>
                    <span class="under-timer-text--3">Секунд</span>
                  </div>
                  <div class="timer-new">
                    <div class="timer__index timer__index--1">
                      <span class="timer__item hour time">00</span>
                    </div>
                    <div class="timer__index">
                      <span class="timer__item min time">26</span>
                    </div>
                    <div class="timer__index">
                      <span class="timer__item sec time">00</span>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <form method="post" action="subscribe.php" class="x_order_form">
              <div class="under_form_header">
                <p class="this_week">На этой неделе товар уже купили:</p>
                <p class="this_week_much"><span class="todayBay">4775</span> человек</p>
              </div>
              <div class="name__phone">
                <p>Введите Ваше Имя</p>
                <input class="x_client_name" type="text" name="name" placeholder="Валерий" required>
              </div>
              <div class="name__phone second">
                <p>Введите Ваш телефон</p>
                <input class="x_client_phone" type="tel" name="phone" placeholder="+ (___) ___-__-__" required>
              </div>
              <p class="attention"><span>Внимание!</span> Осталось товаров со скидкой: </p>
              <p class="how__much lastpack">60</p><span class="sxt"> штук</span>
              <button type="submit">Заказать со скидкой</button>
              <div class="security">
                <p class="cesur">Ваши данные под защитой!</p>
              </div>
            <input type="hidden" name="campaign_id" value="YOUR_CAMPAIGN_ID"><input type="hidden" name="es_list_id" value="50961"></form>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="troubles">
    <div class="container">
      <h2>Какие неприятности приносят круги вокруг глаз?</h2>
      <div class="trouble_item">
        <img src="img/trouble1.png" alt="">
        <p>Визуально увеличивают возраст</p>
      </div>
      <!--
          -->
      <div class="trouble_item">
        <img src="img/trouble2.png" alt="">
        <p>Создают изможденный образ</p>
      </div>
      <!--
          -->
      <div class="trouble_item">
        <img src="img/trouble3.png" alt="">
        <p>Портят впечатление от внешнего вида</p>
      </div>
      <!--
          -->
      <div class="trouble_item">
        <img src="img/trouble4.png" alt="">
        <p>Увеличивают время утреннего макияжа</p>
      </div>
      <!--
          -->
      <div class="trouble_item">
        <img src="img/trouble5.png" alt="">
        <p>Негативно сказываются на личной жизни</p>
      </div>
      <!--
          -->
      <div class="trouble_item last">
        <img src="img/trouble6.png" alt="">
        <p>Стимулируют развитие комплексов</p>
      </div>
      <!--
          -->
      <div class="under_trouble_items">
        <p>Помогите своей коже приобрести ровный и здоровый тон!</p>
      </div>
    </div>
  </section>
  <section class="reasons">
    <div class="container">
      <h2>Причины возникновения темных кругов вокруг глаз:</h2>
      <div class="reasons_items">
        <div class="left_reasons">
          <div class="reason_item">
            <img src="img/reason1.png" alt="">
            <h4>Наследственная предрасположенность</h4>
            <p>Генетически заложенная истонченная кожа вокруг глаз</p>
          </div>
          <div class="reason_item">
            <img src="img/reason2.png" alt="">
            <h4>Недосыпание или посменный график</h4>
            <p>Нарушение питательного режима и регенерации клеток</p>
          </div>
          <div class="reason_item">
            <img src="img/reason3.png" alt="">
            <h4>Гормональные изменения у женщин</h4>
            <p>Во время беременности или менструаций</p>
          </div>
          <div class="reason_item">
            <img src="img/reason4.png" alt="">
            <h4>Стрессовые ситуации</h4>
            <p>Нарушения нервной системы, синдром хронической усталости</p>
          </div>
        </div>
        <div class="right_reasons">
          <div class="reason_item">
            <img src="img/reason5.png" alt="">
            <h4>Разрывы стенок капилляров</h4>
            <p>При ОРЗ или повышении давления</p>
          </div>
          <div class="reason_item">
            <img src="img/reason6.png" alt="">
            <h4>Возрастные изменения кожи</h4>
            <p>Кожа теряет влагу и истончается</p>
          </div>
          <div class="reason_item seventh">
            <img src="img/reason7.png" alt="">
            <h4>Излишняя выработка меланина</h4>
            <p>Тонкая кожа вокруг глаз загорает быстрей</p>
          </div>
          <div class="reason_item">
            <img src="img/reason8.png" alt="">
            <h4>Увлечение диетами</h4>
            <p>Недостаток витаминов и минералов в пище</p>
          </div>
        </div>
      </div>
      <div class="is_it_you">
        <p>Узнали себя? Начните пользоваться Magic Look сейчас, чтобы избавиться от темных кругов под глазами за 2
          недели!</p>
      </div>
    </div>
  </section>
  <section class="ingredients">
    <div class="container">
      <h2>Принцип действия маски Magic Look на кожу вокруг глаз</h2>
      <div class="ingredient_item right_ing">
        <img src="img/ing1.png" alt="">
        <h4>Экстракт конского каштана, гепарин натрия, аскорбиновая кислота и рутин</h4>
        <p>обеспечивают дренаж жидкости и отток лимфы. Снимают отек и нормализуют обменные процессы в коже вокруг глаз
        </p>
      </div>
      <!--
          -->
      <div class="ingredient_item left_ing">
        <img src="img/ing2.png" alt="">
        <h4>Пептиды шелка</h4>
        <p>регулируют уровень меланина, способствуют разглаживанию морщин, заживлению микроповреждений кожи. Защищают от
          негативного воздействия экстремальных температур</p>
      </div>
      <!--
          -->
      <div class="ingredient_item right_ing">
        <img src="img/ing3.png" alt="">
        <h4>Виноградное и облепиховое масла</h4>
        <p>поставляют питательные элементы и увлажняют истонченную кожу. Восстанавливают правильную структуру дермы</p>
      </div>
      <!--
          -->
      <div class="ingredient_item left_ing">
        <img src="img/ing4.png" alt="">
        <h4>Витамины A, E, D-пантенол</h4>
        <p>восстанавливают молодость и тургор кожи. Защищают от преждевременного старения и увядания, укрепляют стенки
          капилляров</p>
      </div>
      <!--
          -->
      <div class="ingredient_item right_ing">
        <img src="img/ing5.png" alt="">
        <h4>Морская соль</h4>
        <p>усиливает проникновение микро- и макроэлементов в проблемную область. Ускоряет процесс регенерации клеток</p>
      </div>
      <!--
          -->
      <div class="ingredient_item left_ing">
        <img src="img/ing6.png" alt="">
        <h4>Эфиры мяты, фундука и чайного дерева</h4>
        <p>отбеливают и тонизируют кожу. Питают витаминами и минералами клетки эпидермиса</p>
      </div>
      <div class="under_ing">
        <p>При регулярном применении Magic Look, Вы восстанавливаете природную красоту здоровой кожи!</p>
      </div>
    </div>
  </section>
  <section class="middle_form">
    <div class="container">
      <div class="form_header">
        <div class="head_form_header no_sale">
          <div class="together">
            <div class="middle_left">
              <div class="form_header">
                ...
                <div class="under_form_header desc">
                  <p class="this_week">На этой неделе товар уже купили:</p>
                  <p class="this_week_much"><span class="todayBay">4775</span> человек</p>
                </div>
              </div>
      ...
      <div class="middle_right">
        <form method="post" action="subscribe.php" class="x_order_form">
          ...
          <button type="submit">Заказать со скидкой</button>
        <input type="hidden" name="campaign_id" value="YOUR_CAMPAIGN_ID"><input type="hidden" name="es_list_id" value="50961"></form>
        <div class="under_form_header middle_none">
          <p class="this_week">На этой неделе товар уже купили:</p>
          <p class="this_week_much"><span class="todayBay">4775</span> человек</p>
        </div>
        <div class="security">
  ...
  <section class="compare">
    <div class="container">
      <h2>Сравните действие Magic Look с другими методами и средствами</h2>
      <div class="other_prod">
        <h3>Другие кремы и средства</h3>
        <div class="other_prod_item">
          <h4>Маскирующий крем</h4>
          <p>не воздействует на причину, закрывает доступ кожи к кислороду.</p>
        </div>
        <div class="other_prod_item two">
          <h4>Соблюдение диеты и режима активности</h4>
          <p>не всегда возможно, нет гарантий улучшения.</p>
        </div>
        <div class="other_prod_item">
          <h4>Народные средства</h4>
          <p>требуют много времени для приготовления.</p>
        </div>
        <div class="other_prod_item">
          <h4>Липолифтинг</h4>
          <p>всегда дает только временный результат, дорого стоит.</p>
        </div>
        <div class="other_prod_item fife">
          <h4>Лимфодренаж</h4>
          <p>воздействует на кожу электрическим током, болезненная процедура.</p>
        </div>
        <div class="other_prod_item">
          <h4>Косметические кремы</h4>
          <p>содержат химические ингредиенты, которые отравляют организм.</p>
        </div>
        <p class="no_help">Ничего не помогает...</p>
      </div>
      <!--
      -->
      <div class="our_prod">
        <h3>Маска Magic Look</h3>
        <div class="our_prod_item">
          <h4>10 биоактивных компонентов </h4>
          <p>питают вашу кожу и возвращают ей молодость. </p>
        </div>
        <div class="our_prod_item">
          <h4>Живете в привычном ритме</h4>
          <p>избавление от потемнений через 14 дней.</p>
        </div>
        <div class="our_prod_item three">
          <h4>Маска готова к применению </h4>
          <p>и удобна в использовании.</p>
        </div>
        <div class="our_prod_item">
          <h4>Восстанавливает структуру здоровой кожи</h4>
          <p>обеспечивает естественное деление клеток эпидермиса.</p>
        </div>
        <div class="our_prod_item fife">
          <h4>Улучшает микроциркуляцию крови </h4>
          <p>и укрепляет стенки сосудов безболезненно.</p>
        </div>
        <div class="our_prod_item">
          <h4>В составе маски только природные компоненты </h4>
          <p>и экстракты лекарственных растений.</p>
        </div>
        <div class="help_people">
          <p>Magic Look помог 4026 людям!</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="opinion">
    <div class="container">
      ...
      <p class="docs_opinion">Перед подписанием договора на <span class="opinion_y">регулярные поставки Magic Look в
          нашу клинику</span>, мы детально изучили состав маски, результаты клинических исследований ее применения и
        посетили производство.
        Несмотря на поразительную эффективность средства в борьбе с <span class="opinion_y">темными кругами вокруг
          глаз</span>, мы лично убедились в его безопасности. <span>
          Наличие сертификатов соответствия, стерильные условия производства и многоступенчатый контроль качества
          итоговой продукции способствовали подписанию договора.
          Благодаря <span class="opinion_y">маске Magic Look</span> наша клиника получила множество благодарных
          пациентов, которые нам доверяют. Они возвращаются к нам с другими вопросами красоты и гармонии тела, советуют
          друзьям.
        </span><span class="opinion_y">Рекомендую маску Magic Look, как эффективное и безопасное средство</span> для
        избавления от темных кругов вокруг глаз.</p>
      <p class="doc_name"><span>Татьяна Ларина</span> врач-косметолог высшей категории, эксперт по косметической
        безопасности клиники эстетической медицины.</p>
    </div>
  </section>

  <section class="clinic">
    <div class="container">
      <h2>Клинические исследования Magic Look</h2>
      <div class="squares">
        <div class="squares_item">
          <img src="img/sq1.png" alt="">
          <p><span>308</span>респондентов</p>
        </div>
        <!--
        -->
        <div class="squares_item two">
          <img src="img/sq2.png" alt="">
          <p><span>14</span>дней</p>
        </div>
        <!--
        -->
        <div class="squares_item three">
          <img src="img/sq3.png" alt="">
          <p><span>3</span>процедуры в неделю</p>
        </div>
      </div>
      <p class="results_p">Рассылка пробников маски 308-ми респондентам с проблемами темных кругов вокруг глаз различной
        этиологии, показала следующие результаты. <span>Через 14 дней после первого использования маски<br> (3
          процедуры в неделю):</span></p>
      <div class="table_clinic">
        <table>
          <caption><span>Характер действия</span> % улучшений <span class="justLarge cap">Результат</span></caption>
          <tbody>
            <tr class="an_color">
              <td>Улучшение цвета кожи вокруг глаз</td>
              <td>100%</td>
              <td class="justLarge"><img src="img/check.png"></td>
            </tr>
            <tr>
              <td>Снижение отеков под глазами</td>
              <td>94%</td>
              <td class="justLarge"><img src="img/check.png"></td>
            </tr>
            <tr class="an_color">
              <td>Осветление кожи под глазами</td>
              <td>92%</td>
              <td class="justLarge"><img src="img/check.png"></td>
            </tr>
            <tr>
              <td>Заметное увлажнение кожи</td>
              <td>100%</td>
              <td class="justLarge"><img src="img/check.png"></td>
            </tr>
            <tr class="an_color">
              <td>Отмечают повышение эластичности</td>
              <td>96%</td>
              <td class="justLarge"><img src="img/check.png"></td>
            </tr>
            <tr>
              <td>Уменьшение глубины мимических морщин</td>
              <td>90%</td>
              <td class="justLarge"><img src="img/check.png"></td>
            </tr>
            <tr class="an_color">
              <td>Устранение темных кругов полностью</td>
              <td>80%</td>
              <td class="justLarge"><img src="img/check.png"></td>
            </tr>
            <tr>
              <td>Заметное выравнивание тона</td>
              <td>100%</td>
              <td class="justLarge"><img src="img/check.png"></td>
            </tr>
          </tbody>
  ...
  <section id="feedback">
    <div class="container">
      <h2>Отзывы людей, которые уже использовали <span>Magic Look</span></h2>
      <div class="hike">
        <div class="video-wrap">
          <div class="youtube" id="60pdmNh8d2U" style="width: 300px; height: 240px;"></div>
          <p>Оксана</p>
        </div>
        <div class="video-wrap">
          <div class="youtube" id="8i6tvFlxXVY" style="width: 300px; height: 240px;"></div>
          <p>Анна</p>
        </div>
        <div class="video-wrap">
          <div class="youtube" id="oMDUqZuBFcw" style="width: 300px; height: 240px;"></div>
          <p>Ирина</p>
        </div>
      </div>
    </div>
  ...
  <section class="vider-rev">
    <div class="container">
      <h2>Опрос об эффективности <span>Magic Look</span></h2>
      <div class="rev_wrap">
        <div class="rev_item">
  ...
  <div class="container">
    <h2>Впечатление людей после 6 процедур с Magic Look (2 недели)</h2>
    <ul class="bxslider">
      <li>
        <img src="img/pers1.jpg" />
        <p>Темные круги вокруг глаз у меня с детства. Врачи говорят — это особенность строения кожи, ничего не сделаешь. Раньше постоянно пользовалась дорогим консилером. Знакомый косметолог посоветовала Magic Look, как классную маску. Я была ошарашена результатом — такого заметного улучшения даже и не вспомню. Кожа гораздо ровнее, пропал этот некрасивый контраст. Друзья меня больше не называют героинщицей))). Спасибо за свежий взгляд!<span>Наталия Аксенова, 23 года.</span></p>
      </li>
      <li>
        <img src="img/pers2.jpg" />
        <p>После 30 лет начала замечать синяки под глазами и припухлости с утра, как будто неделю не спала. Делала ромашковый лед, массаж, компрессики. Но это требует времени, поэтому не всегда получалось. Коллеге хорошо помогла маска Magic Look, решила попробовать и я. Мне понравились приятные ощущения прохлады во время нанесения. Уже на следующий день чувствовала подтянутость кожи, после второй процедуры заметила посветление. Сейчас темных пятен почти не видно, и с утра приятно смотреть в зеркало. Спасибо!!! <span>Валерия Кондратьева, 45 лет.</span> </p>
      </li>
      <li>
        <img src="img/pers3.jpg" />
        <p>Эти темные круги под глазами уже достали. Все бы ничего, но немного мешают. Например, в знакомстве с девушками. В сумерках вообще выглядел как вампир из хоррора. Все средства перепробовал, ничего не помогало. По совету однокурсницы купил Magic Look, она им пользуется после бурных вечеринок. Не ожидал такого поворота — после 6 процедур, кожа под глазами стала однотонной. Отблагодарил девушку походом в кафе. Не вечеринка, но все же))). Спасибо огромное!<span>Владимир Авраменко, 20 лет.</span></p>
      </li>
    </ul>
  </div>
</section> -->

  <section class="way_to_use">
    <div class="container">
      <h2>Способ применения:</h2>
      <div class="way_items">
        <div class="way_item one">
          <img src="img/way1.png" alt="">
          <p class="num">1.</p>
          <p>Очистить кожу вокруг глаз</p>
        </div>
        <div class="way_item two">
          <img src="img/way2.png" alt="">
          <p class="num">2.</p>
          <p>Подсушить полотенцем или салфеткой</p>
        </div>
        <div class="way_item three">
          <img src="img/way3.png" alt="">
          <p class="num">3.</p>
          <p>Нанести маску на орбитальную область</p>
        </div>
        <div class="way_item four">
          <img src="img/way4.png" alt="">
          <p class="num">4.</p>
          <p>Выдержать 10-15 минут</p>
        </div>
        <div class="way_item fife">
          <img src="img/way5.png" alt="">
          <p class="num">5.</p>
          <p>Смочить водой кожу в месте нанесения маски</p>
        </div>
        <div class="way_item six">
          <img src="img/way6.png" alt="">
          <p class="num">6.</p>
          <p>Увлажненным спонжем или тканевой cалфеткой снять маску</p>
        </div>
        <div class="way_item seven">
          <img src="img/way7.png" alt="">
          <p class="num">7.</p>
          <p>Ополоснуть лицо водой и промокнуть косметической салфеткой</p>
        </div>
      </div>
      <p class="under_way">Делать 3-4 процедуры в неделю</p>
    </div>
  </section>
  ...
  <section class="we_work">
    <div class="container">
      ...
      <div class="work_item one">
        <img src="img/work1.png" alt="">
        <p>Вы оставляете заявку</p>
      </div>
      <div class="work_item two">
        <img src="img/work2.png" alt="">
        <p>Мы обрабатываем заказ</p>
      </div>
      <div class="work_item three">
        <img src="img/work3.png" alt="">
        <p>Высылаем по указанному адресу</p>
      </div>
      <div class="work_item four">
        <img src="img/work4.png" alt="">
        <p>Получаете и оплачиваете стоимость</p>
      </div>
      <div class="work_item fife">
        <img src="img/work5.png" alt="">
        <p>Избавляетесь от темных кругов вокруг глаз</p>
      </div>
    </div>
  </section>
  ...
  <div class="container">
    ...
    <div class="around_pop">
      <p class="popular">С ростом популярности маски Magic Look на рынке СНГ, участились случаи подделок. Продукт продается в оригинальной упаковке с уникальным регистрационным кодом!</p>
      <p class="find">Найдите код на упаковке и проверьте его подлинность. Проверьте свой Magic Look:</p>
      <form action="">
        <input class="check_popup_code_input"  placeholder="Введите код с упаковки" required>
        <button class="button-popup-first">Проверить подлинность</button>
    ...
    <div class="container">
      <div class="header_body">
        <div class="container">
          ...
          <div class="col-4 one">
            <div class="just_14">
              <p class="title_ul_header">Помогите себе:</p>
              <ul class="ul_header">
                <li>
                  <p>Избавиться от темных кругов</p>
                </li>
                <li class="yellow">
                  <p>Восстановить здоровье кожи</p>
                </li>
                <li>
                  <p>Сгладить морщины</p>
                </li>
                <li class="yellow">
                  <p>Устранить пигментацию</p>
                </li>
                <li>
                  <p>Вернуть ясный взгляд</p>
                </li>
              </ul>
              <p class="under_title_ul_header">Вы превосходно выглядите!</p>
            </div>
  ...
  <footer>
    <div class="container">
      ...
      <p class="address">ООО "Magic Look", Москва, ул. Калинина, дом 3а </p>
      <p class="politics"><a href="privacy.html" target="_blank">Политика конфиденциальности</a></p>
      <p class="right">ИНН 104380285762<br>ОГРН 427602692592</p>
    </div>
  </footer>
    ...
    <div class="wrap-popup" id="cloneThis">
      <div class="col_form">
        ...
        <form method="post" action="subscribe.php" class="x_order_form">
          ...
          <button type="submit" class="popup-btn">Заказать со скидкой</button>
          <div class="security">
            <p class="cesur">Ваши данные под защитой!</p>
          </div>
        <input type="hidden" name="campaign_id" value="YOUR_CAMPAIGN_ID"><input type="hidden" name="es_list_id" value="50961"></form>
